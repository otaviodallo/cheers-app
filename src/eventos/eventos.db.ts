...
export default class EventosDb{
    public eventos: Evento[] = [
        ...
        new Evento(8, '+55 BAR', new Date(2024, 2, 12), false, false, true),
        ...
        new Evento(12, '+55 BAR', new Date(2024, 8, 22), true, false, true),
        new Evento(13, '+55 BAR', new Date(2024, 2, 10), true, false, true),
        new Evento(14, '+55 BAR', new Date(2024, 5, 10), true, false, true),
        new Evento(15, '+55 BAR', new Date(2024, 2, 10), true, false, true),
        new Evento(16, '+55 BAR', new Date(2024, 8, 30), true, false, true),
